...
JUST TO MAKE IT CLEAR, DUE TO LIMITATIONS OF THE CHEAPER RTL-SDR DONGLES, "CLOCK DRIFT" CANNOT
EASILY BE ADDRESSED, SO EXPECT SOME AUDIO ARTEFACTS CAUSED BY BUFFER UNDERRUNS ALONG WITH 
LIMITATIONS IN PERFORMANCE, THE ONLY WAY TO FIX THE PROBLEM IS TO GET A BETTER QUALITY
SDR CAPTURE DEVICE, CHECK THE RELEASE NOTES!.
